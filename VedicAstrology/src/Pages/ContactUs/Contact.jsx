  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content="https://www.vedicjyotishe.com/contact" />
          ...
          <div className="contact-form-section">
            ...
            <div className="row contact-info justify-content-center">
              ...
              <div className="col-md-3 info-box">
                ...
                <p>
                  <a href="tel:000-123-456789">000-123-456789</a>
                  <a href="tel:000-123-456789">000-123-456789</a>
                </p>
              </div>
            </div>
      ...
      <section>
        <div className="container-fluid">
          <div className="row">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d448196.52633258584!2d76.76357436215979!3d28.64368462633545!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfd5b347eb62d%3A0x37205b715389640!2sDelhi!5e0!3m2!1sen!2sin!4v1729488593706!5m2!1sen!2sin"
              width="1500"
              height="500"
              style={{ border: "0" }}
              allowFullScreen=""

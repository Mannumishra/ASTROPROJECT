...
const Kundali = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const inquiryRes = await axios.post(`http://localhost:8000/api/send-service-inquery`, formData);
      ...
      const options = {
        ...
        handler: async function (response) {
          ...
          // Verify the payment
          const verificationResponse = await axios.post('http://localhost:8000/api/verify-payment', {
                ...
                <div className="container">
                  <div className="col">
                    ...
                    {stepOne ? (
                      <div>
                        ...
                        <div className="formsubHeading">
                          ...
                          <div className="col-md-12 namefield mb-2">
                            ...
                            <input type="text" onChange={handleChange} name="place" className="form-control form-input" placeholder="Place Of Birth" required />
                          </div>
                        </div>
                        ...
                        <div className="formsubHeading">
                          ...
                          <div className="Longitude">
                            ...
                            <div className="directionbtn">
                              <button type="button" className={`direction-btn btn ${direction === "North" ? "btn-warning" : ""}`} onClick={() => setDirection("North")}>North</button>
                              <button type="button" className={`direction-btn btn ${direction === "South" ? "btn-warning" : ""}`} onClick={() => setDirection("South")}>South</button>
                            </div>
                          </div>
                      ...
                      <section>
                        <div className="container Addresspage my-4">
                          ...
                          <div className="row mb-3">
                            <div className="col-md-6">
                              ...
                              <input type="text" onChange={handleChange} name="country" className="form-control" id="country" placeholder="Country" required />
                            </div>
